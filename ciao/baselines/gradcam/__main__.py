"""Entrypoint for running GradCAM / GradCAM++ explanations over a batch of images."""
...
from ciao.baselines.gradcam.explainer import GradCAMExplainer
from ciao.data.loader import iter_image_paths
from ciao.model.predictor import ModelPredictor


@hydra.main(
    version_base=None, config_path="../../../configs", config_name="gradcam_base"
)
def main(cfg: DictConfig) -> None:
    ...
    with mlflow.start_run(run_name=cfg.logger.run_name):
        ...
        for image_path in iter_image_paths(cfg):
            print(f"[{method_label}] Starting explanation for: {image_path}")
            ...
            with run_ctx as run:
                ...
                if cfg.logger.log_figures:
                    log_figures(results)
                print_summary(image_path, results, elapsed, method_label=method_label)
